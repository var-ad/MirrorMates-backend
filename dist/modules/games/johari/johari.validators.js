...
const responseIdentityModeSchema = validate_1.z.enum(["anonymous", "named"]);
function hasAtLeastOneInviteSetting(input) {
    return (input.inviteExpiresInDays !== undefined ||
...
exports.inviteSubmitSchema = validate_1.z.object({
    displayName: validate_1.z.string().trim().max(50).optional(),
    adjectiveIds: adjectiveIdsSchema
});
